    ...
    <el-card>
      ...
      <el-form :inline="true" :model="queryForm">
        ...
        <el-form-item label="出库类型">
          <el-select v-model="queryForm.stockType" placeholder="出库类型" clearable>
      ...
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="stockType" label="出库类型" width="120" />
        <el-table-column prop="warehouseName" label="仓库" width="120" />
        <el-table-column prop="stockDate" label="出库日期" width="120" />
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            ...
            <el-button v-perm="'inventory:stock-out:audit'" link type="success" @click="handleApprove(row)" v-if="row.status === 0">审核</el-button>
            <el-button v-perm="'inventory:stock-out:delete'" link type="danger" @click="handleDelete(row)" v-if="row.status === 0">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
