...
export function getBundleList(params: any) {
  return request({ url: '/bundle/list', method: 'get', params })
}

export function getBundle(id: number) {
  return request({ url: `/bundle/${id}`, method: 'get' })
}

export function createBundle(data: any) {
  return request({ url: '/bundle', method: 'post', data })
}

export function updateBundle(id: number, data: any) {
  return request({ url: `/bundle/${id}`, method: 'put', data })
}

export function deleteBundle(id: number) {
  return request({ url: `/bundle/${id}`, method: 'delete' })
}

export function getPatrolCheckList(params: any) {
  return request({ url: '/quality/patrols', method: 'get', params })
}

export function getPatrolCheck(id: number) {
  return request({ url: `/quality/patrols/${id}`, method: 'get' })
}

export function createPatrolCheck(data: any) {
  return request({ url: '/quality/patrols', method: 'post', data })
}

export function updatePatrolCheck(id: number, data: any) {
  return request({ url: `/quality/patrols/${id}`, method: 'put', data })
}

export function deletePatrolCheck(id: number) {
  return request({ url: `/quality/patrols/${id}`, method: 'delete' })
}

export function getAqlList(params: any) {
  return request({ url: '/quality/aql', method: 'get', params })
}

export function getAql(id: number) {
  return request({ url: `/quality/aql/${id}`, method: 'get' })
}

export function createAql(data: any) {
  return request({ url: '/quality/aql', method: 'post', data })
}

export function updateAql(id: number, data: any) {
  return request({ url: `/quality/aql/${id}`, method: 'put', data })
}

export function deleteAql(id: number) {
  return request({ url: `/quality/aql/${id}`, method: 'delete' })
}

export function calculateAql(batchSize: number, level: string) {
  return request({ 
    url: '/quality/aql/calculate', 
    method: 'get', 
...
export function getReworkList(params: any) {
  return request({ url: '/quality/reworks', method: 'get', params })
}

export function getRework(id: number) {
  return request({ url: `/quality/reworks/${id}`, method: 'get' })
}

export function getReworkByCheckId(checkId: number) {
  return request({ url: `/quality/reworks/by-check/${checkId}`, method: 'get' })
}

export function createRework(data: any) {
  return request({ url: '/quality/reworks', method: 'post', data })
}

export function updateRework(id: number, data: any) {
  return request({ url: `/quality/reworks/${id}`, method: 'put', data })
}

export function deleteRework(id: number) {
  return request({ url: `/quality/reworks/${id}`, method: 'delete' })
}
