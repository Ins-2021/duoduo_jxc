...
export function getFabricList(params: any) {
  return request({ url: '/fabrics/page', method: 'get', params })
}

export function getFabric(id: number) {
  return request({ url: `/fabrics/${id}`, method: 'get' })
}

export function createFabric(data: any) {
  return request({ url: '/fabrics', method: 'post', data })
}

export function updateFabric(id: number, data: any) {
  return request({ url: `/fabrics/${id}`, method: 'put', data })
}

export function deleteFabric(id: number) {
  return request({ url: `/fabrics/${id}`, method: 'delete' })
}

export function getFabricAll() {
  return request({ url: '/fabrics/list', method: 'get' })
}

export function getFabricInboundList(params: any) {
  return request({ url: '/fabrics/inbounds/page', method: 'get', params })
}

export function getFabricInbound(id: number) {
  return request({ url: `/fabrics/inbounds/${id}`, method: 'get' })
}

export function createFabricInbound(data: any) {
  return request({ url: '/fabrics/inbounds', method: 'post', data })
}

export function approveFabricInbound(id: number) {
  return request({ url: `/fabrics/inbounds/${id}/approve`, method: 'post' })
}

export function deleteFabricInbound(id: number) {
  return request({ url: `/fabrics/inbounds/${id}`, method: 'delete' })
}

export function getFabricRequisitionList(params: any) {
  return request({ url: '/fabrics/requisitions/page', method: 'get', params })
}

export function getFabricRequisition(id: number) {
  return request({ url: `/fabrics/requisitions/${id}`, method: 'get' })
}

export function createFabricRequisition(data: any) {
  return request({ url: '/fabrics/requisitions', method: 'post', data })
}

export function approveFabricRequisition(id: number, comment: string, approved: boolean) {
  return request({ 
    url: `/fabrics/requisitions/${id}/approve`, 
    method: 'post', 
...
export function issueFabricRequisition(id: number) {
  return request({ url: `/fabrics/requisitions/${id}/issue`, method: 'post' })
}

export function deleteFabricRequisition(id: number) {
  return request({ url: `/fabrics/requisitions/${id}`, method: 'delete' })
}

export function getFabricInventoryList(params: any) {
  return request({ url: '/fabrics/inventory/page', method: 'get', params })
}

export function getFabricInventoryByFabricId(fabricId: number) {
  return request({ url: `/fabrics/inventory/${fabricId}`, method: 'get' })
}

export function lockFabricStock(warehouseId: number, fabricId: number, quantity: number) {
  return request({ 
    url: '/fabrics/inventory/lock', 
    method: 'post', 
...
export function getFabricAlerts() {
  return request({ url: '/fabrics/inventory/alerts', method: 'get' })
}
